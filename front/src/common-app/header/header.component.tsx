    ...
    <header className={classes.header}>
      <div className={classes.container}>
        <div className={classes.contentLeft}>
          <h3 className={classes.titleHeader}>{currentlyUserData && currentlyUserData?.userId ? "Welcome " + currentlyUserData?.name + "!" : "My Web Page"}</h3>
          ...
          <nav className={classes.navbar}>
            <ul>
              <li className={classes.liAnchor}>
                <Link to={SwitchRoutes.dashboard}>{currentlyUserData && currentlyUserData?.userId ? "All User" : "Login"}</Link>
              </li>
              {currentlyUserData && currentlyUserData?.userId &&
              <>
               <li className={classes.liAnchor}>
                 <Link to={`${SwitchRoutes.deleteUser}/${currentlyUserData?.userId}`}>Delete profile</Link>
               </li>
               <li className={classes.liAnchor}>
                 <Link to={`${SwitchRoutes.updateUser}/${currentlyUserData?.userId}`}>Modify profile</Link>
               </li>
              </>
              }
